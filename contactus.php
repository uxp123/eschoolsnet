...
<head>
	...
	<title>E-schools Social Network</title>
...
<div class="theme-layout">
	...
	<div class="topbar transparent">
		<div class="logo">
			<a title="" href="index.php"><img src="images/logo.png" alt="" height="60px" width="60px"></a>
		</div>
	...
	<section>
		<div class="ext-gap bluesh high-opacity">
			<div class="content-bg-wrap" style="background: url(videos/pilot.png)"></div>
							...
							<div class="branches-box">
								<ul>
									<li>
										...
										<span>Aves International Academy, VRA Road Community 25, Tema </span>
									</li>
									<li>
										<i class="fa fa-phone"></i>
										<span>(+233) 266-153097</span>
									</li>
									<li>
										<i class="fa fa-envelope-o"></i>
										<span>info@avesacademy.com</span>
									</li>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="widget">
						<div class="foot-logo">
							<div class="logo">
								<a href="index.php" title=""><img src="images/logo.png" alt="" height="60px" width="60px"></a>
							</div>	
						...
						<ul class="location">
							<li>
								...
								<p>Aves International Academy, VRA Road Community 25, Tema</p>
							</li>
							<li>
								<i class="ti-mobile"></i>
								<p>(+233) 266-153097</p>
				...
				<div class="col-lg-2 col-md-4">
					<div class="widget">
						...
						<ul class="list-style">
							<li><i class="fa fa-twitter-square"></i><a href="https://www.facebook.com/avesacademy/" title="">Facebook</a></li>
							<li><i class="fa fa-instagram"></i><a href="https://www.linkedin.com/company/avesinternationalacademy" title="">LinkedIn</a></li>
							<li><i class="fa fa-google-plus-square"></i> <a href="https://www.instagram.com/avesacademy/?hl=en" title="">Instagram</a></li>
				...
				<div class="col-lg-2 col-md-4">
					<div class="widget">
						<div class="widget-title"><h4>Source Codes</h4></div> 
						<ul class="colla-apps">
							<li><a href="https://github.com/uxp123/eschoolsnet" title=""><i class=""></i>E-schoolsnet</a></li>
							<li><a href="https://github.com/uxp123/eschoolsnet-middleware" title=""><i class=""></i>E-scholsnet middleware</a></li>
							<li><a href="https://github.com/uxp123/eschoolsnet-microservices" title=""><i class=""></i>E-schoolsnet microservices</a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<div class="bottombar">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<span class="copyright">© E-schools Social Network 2020. All rights reserved.</span>
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBjCCD6P8woRMDfsiWanIWKq1wm9TgDA2s"></script>
